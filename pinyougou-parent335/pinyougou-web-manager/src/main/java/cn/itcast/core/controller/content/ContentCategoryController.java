...
public class ContentCategoryController {
	...
	public entity.PageResult findPage(Integer page, Integer rows) throws Exception {
		entity.PageResult pageResult = categoryService.findPage(null, page, rows);
		return pageResult;
	}
	...
	public entity.PageResult search(@RequestBody ContentCategory contentCategory, Integer page, Integer rows)
			throws Exception {
		entity.PageResult pageResult = categoryService.findPage(contentCategory, page, rows);
		return pageResult;
	}
}
